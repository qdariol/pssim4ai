...
void MB0::Execute()
{
    for(int i = 0; i < num_iter; i++)
    {
        ...
        buff_l2c1_output = this->WriteTokens(read_l2c1_output, write_l2c1_output, buff_l2c1_output, 1, L2_C1, t_r_loop, i, ENABLE_CLOCK_GATING);
