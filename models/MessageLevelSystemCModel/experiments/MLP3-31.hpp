...
void MB2::Execute()
{
    for(int i = 0; i < num_iter; i++)
    {
        ...
        std::cout << i << ",MB2,L2_C1,START," << sc_core::sc_time_stamp().value()/1000 << std::endl;
        sc_core::wait(Delay_L2_C1.GetDelay());
        std::cout << i << ",MB2,L2_C1,STOP," << sc_core::sc_time_stamp().value()/1000 << std::endl;
...
void MB3::Execute()
{
    for(int i = 0; i < num_iter; i++)
    {
        ...
        std::cout << i << ",MB3,L2_C2,START," << sc_core::sc_time_stamp().value()/1000 << std::endl;
        sc_core::wait(Delay_L2_C2.GetDelay());
        std::cout << i << ",MB3,L2_C2,STOP," << sc_core::sc_time_stamp().value()/1000 << std::endl;
...
void MB4::Execute()
{
    for(int i = 0; i < num_iter; i++)
    {
        ...
        std::cout << i << ",MB4,L3_C1,START," << sc_core::sc_time_stamp().value()/1000 << std::endl;
        sc_core::wait(Delay_L3_C1.GetDelay());
        std::cout << i << ",MB4,L3_C1,STOP," << sc_core::sc_time_stamp().value()/1000 << std::endl;
...
void MB5::Execute()
{
    for(int i = 0; i < num_iter; i++)
    {
        ...
        std::cout << i << ",MB5,L3_C2,START," << sc_core::sc_time_stamp().value()/1000 << std::endl;
        sc_core::wait(Delay_L3_C2.GetDelay());
        std::cout << i << ",MB5,L3_C2,STOP," << sc_core::sc_time_stamp().value()/1000 << std::endl;
